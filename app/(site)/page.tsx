    ...
    <div className="bg-white text-[#1A1A1A]">
      ...
      <section className="relative overflow-hidden border-b border-[#E5E5E5]">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-4 pb-28 pt-32 sm:px-6 lg:px-8">
          ...
          <h1 className="animate-fade-in-up delay-100 mt-5 max-w-4xl text-4xl font-black leading-[1.08] text-white sm:text-6xl lg:text-7xl">
            Potencial estudantil.<br />
            <span className="text-[#BB0A24]">Impacto real.</span>
          </h1>
          <p className="animate-fade-in-up delay-200 mt-7 max-w-2xl text-lg leading-7 text-white/70">
          ...
          <div className="animate-fade-in-up delay-300 mt-10 flex flex-wrap gap-4">
            <Link
              href="/sobre-nos"
              className="rounded-none border border-white/30 px-7 py-3.5 text-sm font-semibold text-white transition-all duration-200 hover:border-white hover:bg-white/10 hover:-translate-y-px active:translate-y-0"
            >
              Conheça o GAS
            </Link>
            <Link
              href="/projetos"
              className="rounded-none border border-[#BB0A24] bg-[#BB0A24] px-7 py-3.5 text-sm font-semibold text-white transition-all duration-200 hover:bg-[#8F071B] hover:border-[#8F071B] hover:-translate-y-px active:translate-y-0"
            >
              Ver Projetos
            </Link>
          </div>
      ...
      <section className="border-b border-[#E5E5E5] py-20">
        <div className="mx-auto grid w-full max-w-7xl gap-0 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <ScrollReveal direction="left" className="border-r border-[#E5E5E5] pr-12">
            ...
            <Link
              href="/sobre-nos"
              className="group mt-8 inline-flex items-center gap-2 text-sm font-semibold text-[#BB0A24] hover:underline"
            >
          ...
          <ScrollReveal direction="right" delay={120} className="pl-12">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {impactNumbers.map((item, i) => (
              <ScrollReveal key={item.label} direction="up" delay={i * 90}>
                <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-8 text-center backdrop-blur-sm transition-all duration-300 hover:bg-white/10 hover:border-white/20 hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/30">
                  {/* Subtle glow on hover */}
                  <div className="absolute inset-0 rounded-2xl opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                    style={{ background: "radial-gradient(ellipse at 50% 0%, rgba(187,10,36,0.15) 0%, transparent 70%)" }}
                  />
                  <p className="relative text-5xl font-black text-[#BB0A24]">
                    <CountUp value={item.value} />
                  </p>
                  <p className="relative mt-3 text-sm text-white/60">{item.label}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
      ...
      <section className="border-b border-[#E5E5E5] py-20">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <ScrollReveal direction="none" className="flex flex-wrap items-end justify-between gap-4 border-b border-[#E5E5E5] pb-8">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.25em] text-[#BB0A24]">
                Nossos Projetos
              </p>
                          ...
                          <div className="absolute inset-x-0 bottom-0 p-4">
                            <div className="rounded-xl border border-white/10 bg-black/40 p-4 shadow-xl backdrop-blur-md transition-transform duration-300 group-hover:-translate-y-1">
                              ...
                              <div className="grid transition-all duration-400 overflow-hidden max-h-0 group-hover:max-h-24 mt-0 group-hover:mt-2">
                                <p className="text-sm text-white/70 leading-6 line-clamp-3">
                                  {project.description}
                                </p>
                              </div>
                              <div className="flex items-center gap-1 text-xs font-semibold text-[#BB0A24] opacity-0 transition-opacity duration-300 group-hover:opacity-100 mt-0 group-hover:mt-3">
                                Ver projeto <span className="transition-transform duration-200 group-hover:translate-x-0.5 inline-block">→</span>
                              </div>
                            </div>
                          </div>
                        </div>
      ...
      <section className="border-b border-[#E5E5E5] bg-[#BB0A24] py-20 text-white">
        <div className="mx-auto grid w-full max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-2 lg:items-center lg:px-8">
          ...
          <ScrollReveal direction="right" delay={120} className="flex flex-col gap-4 lg:items-end">
            <Link
              href="/como-fazer-parte#membro"
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-white bg-white px-7 py-3.5 text-sm font-semibold text-[#BB0A24] transition-all duration-200 hover:bg-white/90 hover:-translate-y-px active:translate-y-0"
            >
              Quero ser Membro
            </Link>
            <Link
              href="/como-fazer-parte#voluntario"
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/40 px-7 py-3.5 text-sm font-semibold text-white transition-all duration-200 hover:border-white hover:bg-white/10 hover:-translate-y-px active:translate-y-0"
            >
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
              {[
                ...
                <Link
                  key={link.href}
                  href={link.href}
                  className="group flex items-center justify-center rounded-2xl border border-[#E5E5E5] px-6 py-8 text-sm font-semibold text-[#1A1A1A] transition-all duration-200 hover:bg-[#BB0A24] hover:text-white hover:border-[#BB0A24] hover:-translate-y-0.5 hover:shadow-md"
                >
